...
public class Exercises {
     ...
     *
     * Override the `toString()` method in the Person class to display the object's n, ame, ageand address in a user-friendly format.
     *
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Person user = new Person("Giovanni", 18, "Via Giacomo Leopardi 18");
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        Person user1 = new Person("Giovanni", 18, "Via Giacomo Leopardi 18");
        Person user2 = new Person("Giovanni", 19, "Via Giacomo Leopardi 18");

        HashSet<Integer> people = new HashSet<>();
        people.add(user1.hashCode());
        people.add(user2.hashCode());
