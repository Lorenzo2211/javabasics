...
import javaoopadvanced.oopadvanced._1.Bird;
...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        System.out.println("Is the car moving forward? " + car.moveForward(true));
        System.out.println("is the car moving backward? " +car.moveBackward(false));

        System.out.println("Is the boat moving backward? " + boat.moveBackward(true));
        System.out.println("Is the boat moving forward? " + boat.moveForward(false));
    }
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        // Your code here
        Guitar guitar = new Guitar("ST5BK", "Vision Sound");
        Piano piano = new Piano("DP-501", "Hemingway");
        System.out.println("Lorenzo is playing the guitar? " + guitar.play(true));
        System.out.println("Lorenzo is playing the piano? " + piano.play(false));
    }
}
