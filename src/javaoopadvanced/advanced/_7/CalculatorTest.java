package javaoopadvanced.advanced._7;
...
class CalculatorTest {
    ...
    void exercise1() {
        ...
        Assertions.assertEquals(5, calculator.add(-7,12));
        Assertions.assertEquals(5, calculator.add(5,0));

        Assertions.assertEquals(12, calculator.subtract(20, 8));
        Assertions.assertEquals(-18, calculator.subtract(-10, 8));
        Assertions.assertEquals(8, calculator.subtract(8, 0));
    }
    ...
    void exercise2() {
        ...
        Assertions.assertEquals(3, calculator.divide(15,5));
        Assertions.assertEquals(-0.7, calculator.divide(-7,10));

        Assertions.assertEquals(24, calculator.multiply(3,8));
    ...
    void exercise3() {
        ...
        Assertions.assertEquals(16, calculator.power(2, 4));
        Assertions.assertEquals(-27, calculator.power(-3, 3));

        Assertions.assertEquals(1, calculator.power(7, 0));
        Assertions.assertEquals(7, calculator.power(7, 1));
        Assertions.assertEquals(0.00032, calculator.power(5,-5));
    }
}