...
public class Main {
    ...
    public static void exercise2() {
        ...
        menuItems.add("Costoletta di maiale");
        menuPrices.add(5.99);

        menuItems.add("Alette di pollo");
        menuPrices.add(4.99);

        menuItems.add("Piatto del giorno");
        menuPrices.add(7.0);
    ...
    public static void exercise3() {
        ...
        //Write your code here
        int sumOfItem = items[0] + items[1] + items[2] + items[3] + items[4] +
                        items[5] + items[6] + items[7] + items[8] +  items[9];

        System.out.println(sumOfItem);
    }
}
