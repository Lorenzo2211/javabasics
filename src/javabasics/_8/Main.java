...
public class Main {
    ...
    private static void exercise1() {
        ...
        int increasingOurNumber = ourNumber + 2;
        System.out.println(String.valueOf(increasingOurNumber));
    }
    ...
    private static void exercise4() {
        ...
        double convertingToDouble = Double.valueOf(concatenatngOurString) / 3.5;
        System.out.println(Math.floor(convertingToDouble));
    }
}