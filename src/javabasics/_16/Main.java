...
public class Main {
    ...
    private static void exercise1() {
        ...
        // End
        System.out.println(convertingOurTemperature());
    }
    ...
    private static void exercise2() {
        ...
        for (String name : names) {
            ...
            System.out.println(nameFixing(name));
            }
    }
    static String nameFixing (String name) {
        ...
        for (int i = 0; i < name.length(); i++) {
            if (number.contains(name.charAt(i))) {
                return "Invalid";
            }
        }
        return name;
        ...
        static void printOut (double myLunchPrice, String lunchType, String description, int weightInGrams){
